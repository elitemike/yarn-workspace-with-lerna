...
```shell
npm i github:your_github_username/control-set-ui
# or if you use bitbucket
npm i bitbucket:your_github_username/control-set-ui
# or if you use gitlab
npm i gitlab:your_github_username/control-set-ui
# or plain url
npm i https:/github.com/your_github_username/control-set-ui.git
```

Then load the plugin in app's `main.ts` like this.
```js
aurelia.use.plugin('control-set-ui');
